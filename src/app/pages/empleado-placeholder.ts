...
@Component({
  selector: 'app-empleado-placeholder',
  standalone: true,
  template: `
    <div style="padding: 3rem; text-align: center; font-family: sans-serif; background: #0f172a; color: white; height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
      ...
      <p style="color: #94a3b8; margin-top: 1rem;">La interfaz para el rol Empleado se habilitará en las siguientes fases.</p>
...
export class EmpleadoPlaceholderComponent {
